import{a as c,i as M,F as C,S,N as x,P as B}from"./assets/vendor-DmemAwzw.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();const P={container:document.getElementById("feedbacks-container")},w=document.querySelector(".sweeties-category-list"),D=document.querySelector("#sweeties-category-select"),u=document.querySelector(".sweeties-category-loader"),m=document.querySelector(".sweeties-desserts-list"),o=document.querySelector(".sweeties-load-more-btn"),a=document.querySelector(".sweeties-desserts-loader"),h="https://deserts-store.b.goit.study/api",g=["/desserts","/categories","/orders","/feedbacks"],v={li:"sweeties-dessert-card dessert-card",img:"sweeties-dessert-img",content:"sweeties-dessert-content-wrapper",contentHeader:"sweeties-dessert-all-text-wrapper",category:"sweeties-dessert-category",nameWrapper:"sweeties-dessert-text-wrapper",name:"sweeties-dessert-title-name",description:"sweeties-dessert-desc",priceWrapper:"sweeties-dessert-price-wrapper",price:"sweeties-dessert-price",button:"sweeties-dessert-btn"};c.defaults.baseURL=h;const E=8;async function H(){return(await c.get(g[1])).data}async function y(t=1,e){const n={params:{page:t,limit:E}};return e!==void 0&&(n.params.category=e),(await c.get(g[0],n)).data}async function F(t=1,e=10){const n={params:{page:t,limit:e}};return(await c.get(g[3],n)).data}function d(t){M.show({title:"Error",message:t,titleColor:"white",messageColor:"white",position:"topRight",backgroundColor:"red"})}function b({totalItems:t,limit:e,page:n}){return t-e*n>0}function q(t){return t.map(({_id:n,name:r})=>({text:r,value:n,class:"sw-cat-select-item"}))}function W(t){return t.map(({_id:n,name:r})=>`<label class="sweeties-category-label">
        <input
          type="radio"
          value="${n}"
...
<path d="M31.829 11.312l0.128 0.4c0.105 0.302 0.017 0.637-0.223 0.848l-7.755 6.64 2.298 9.952c0.078 0.318-0.042 0.652-0.303 0.848l-0.351 0.24c-0.136 0.107-0.305 0.164-0.479 0.16-0.146 0.003-0.29-0.036-0.415-0.112l-8.728-5.328-8.68 5.328c-0.125 0.076-0.269 0.115-0.415 0.112-0.173 0.004-0.342-0.053-0.479-0.16l-0.399-0.24c-0.262-0.196-0.381-0.53-0.303-0.848l2.298-9.952-7.739-6.624c-0.252-0.209-0.348-0.554-0.239-0.864l0.176-0.4c0.093-0.316 0.374-0.54 0.702-0.56l10.196-0.816 3.909-9.424c0.125-0.313 0.43-0.516 0.766-0.512h0.415c0.333-0.007 0.634 0.198 0.75 0.512l3.973 9.424 10.196 0.816c0.328 0.020 0.609 0.244 0.702 0.56zM22.574 25.696l-1.787-7.488 5.856-5.008-7.675-0.608-2.968-7.136v16.224l6.574 4.016z"></path>
  ...
  `}function A(t){return t.map(e=>z(e)).join("")}async function T(t){const{container:e}=P;if(e)try{const r=(await F(1,10)).feedbacks;if(!r||r.length<3){d("Недостатньо відгуків для відображення.");return}e.innerHTML=A(r),t()}catch(n){console.error(n),d("Не вдалося завантажити відгуки клієнтів.")}}let k=1,$;function p(t){a.hidden=!1,u.hidden=!1,y(1,t).then(({desserts:e,...n})=>{m.innerHTML=L(e,v),$=t,k=1,b(n)?(o.classList.remove("is-hidden"),o.addEventListener("click",f)):(o.classList.add("is-hidden"),o.removeEventListener("click",f))}).catch(e=>{d(e.message)}).finally(()=>{a.hidden=!0,u.hidden=!0})}function f(){a.hidden=!1,o.disabled=!0,y(++k,$).then(({desserts:t,...e})=>{m.insertAdjacentHTML("beforeend",L(t,v)),b(e)||(o.classList.add("is-hidden"),o.removeEventListener("click",f))}).catch(t=>{d(t.message)}).finally(()=>{a.hidden=!0,o.disabled=!1})}const j=new C({select:D,events:{afterChange:([{value:t}])=>{if(t==="Всі десерти"){p();return}p(t)}},settings:{showSearch:!1,openPosition:"down"}});H().then(t=>{j.setData([{text:"Всі десерти",class:"sw-cat-select-item"},...q(t)]),w.insertAdjacentHTML("beforeend",W(t)),w.addEventListener("change",({target:{value:e}})=>{p(e===""?void 0:e)})}).catch(t=>{console.log(t)}).finally(()=>{u.hidden=!0,a.hidden=!0});c.defaults.baseURL=h;function N(){new S(".feedback-slider",{modules:[x,B],direction:"horizontal",spaceBetween:24,grabCursor:!0,observer:!0,observeParents:!0,slidesPerGroup:1,slidesPerView:1,breakpoints:{768:{slidesPerView:3,slidesPerGroup:1}},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0,dynamicBullets:!0,dynamicMainBullets:4}})}document.addEventListener("DOMContentLoaded",()=>{T(N)});new Accordion(".accordion-container",{showMultiple:!1,duration:400});const R=document.querySelector(".footer-legal"),I=new Date().getFullYear();R.innerHTML=`&copy; ${I} Солодка Майстерня. Усі права захищені.`;
